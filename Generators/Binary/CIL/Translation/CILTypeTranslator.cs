...
namespace CommonIR.Generators.Binary.CIL.Translation
{
    internal class CILTypeTranslator
    {
        public static IRModule? Module { get; set; }

        static Dictionary<IRStructSchema, Type> StructCache = [];
        ...
        public static Type TranslateIRType(IRType type)
        {
            ...
            {
                if (type.UserObject is not IRStructSchema irStruct)
        ...
        public static Type TranslateIRStruct(IRStructSchema irStruct)
        {
