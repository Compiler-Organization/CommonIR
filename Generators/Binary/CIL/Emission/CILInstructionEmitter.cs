...
using CommonIR.Generators.Binary.CIL.Translation;
...
namespace CommonIR.Generators.Binary.CIL.Emission
{
    internal class CILInstructionEmitter
    {
        ...
        void EmitLoadString(IRConstantString str)
        {
