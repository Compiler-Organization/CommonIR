...
{
    public class IRStructSchema : IRObject, IRValueInstruction
    {
        ...
        public List<IRStructProperty> Properties { get; private set; }
        ...
        internal Type? CILType { get; set; }
         ...
         internal IRStructSchema(string name, List<IRStructProperty> properties)
        {
            this.Name = name;
